...
debug_mode = True
root_link = "http://www.jssbb.gov.cn:81/"
decode_type = "utf-8"
...
######################################################################
gov_apartment_line_finder = re.compile("href='Zrbj(.*?)</li>")
gov_apartment_link_finder = re.compile("Main(.*?)'>")
gov_apartment_name_finder = re.compile("省(.*?)</a>")
